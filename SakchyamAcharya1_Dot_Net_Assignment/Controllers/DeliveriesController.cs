...
namespace SakchyamAcharya1_Dot_Net_Assignment.Controllers
{
    public class DeliveriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CuisineType,DeliveryAddress,DeliveryStatus,DeliveryDate,DeliveryPersonName,ContactNumber")] Delivery delivery)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CuisineType,DeliveryAddress,DeliveryStatus,DeliveryDate,DeliveryPersonName,ContactNumber")] Delivery delivery)
        {
            if (id != delivery.Id)
            {
                return NotFound();
